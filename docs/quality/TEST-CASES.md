...
- **TC-001** Existencia de homepage/hub/páginas pilar.
...
- **TC-020** Documentos/ADR obligatorios.
- **TC-021** title/description/canonical/H1.
- **TC-022** canonical en sitemap.
- **TC-023** JSON-LD parseable.
- **TC-024** Intención SEO/enlazado.
- **TC-025** Netlify único deploy automático.
- **TC-026** Simular release.
- **TC-027** Check posterior a release.
- **TC-028** Smoke programado.
- **TC-029** Workflow con tests/gates.
- **TC-030** CodeQL/Sonar antes de release significativo.
- **TC-031** Revisión de High.
- **TC-032** Trazabilidad completa.
- **TC-033** Checklist PR para arquitectura/seguridad.

## Procedimiento manual visual
1. Carga sin cache.
2. Claro/oscuro.
3. 320, 390, 768 y 1440 px.
4. Solo teclado.
